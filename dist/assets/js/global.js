...
// scroll to menu item
    ...
    $("#contact-form-miami").submit(function(){
        var form =  $(this);
        $.ajax({
            type: "POST",
            url: "mail.php",
            ...
            form.find(".submit-wrapper ").hide();
            form.find("#feedbackOk2").show();
        });
        return false;
    });
    ...
    $("#reservation-form-miami").submit(function(){
        var form =  $(this);
        $.ajax({
            type: "POST",
            url: "reserved.php",
